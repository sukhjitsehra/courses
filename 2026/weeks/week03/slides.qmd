---
title: "Regression"
subtitle: "<font style='font-size:0.6em;'>Supervised Learning</font>"
...
## Visualization of Fit{background-color="white"}
...
## Assessing Accuracy of Coefficient Estimates Contd..
...
## Standard error of regression coefficients Contd ..{background-color="white"}
...
## Using SE in hypothesis testing Contd...{background-color="white"}


![](images/03-table3_1.png)
...
## Computing Standard Errors {background-color="white"}
...
![](images/03-fig3_4.png){width=4in fig-align="center"}
...
## Important Questions in MLR {.incremental}
...
4. **Making and assesing predictions:** *Given a set of predictor values, what response value should we predict, and how accurate is our prediction?* Three sets of uncertainty in predictions:
    ...
    - Irreducible error $\epsilon$ (use **prediction interval**): even if we know the true $\beta_i$, there is still $\epsilon$! PI is wider than CI because it incorporates all all kinds of errors.
...
![](images/fig3_13.png){width=4in, fig-align="center"}
...
![](images/03-fig3_16.png){fig-align="center"}
